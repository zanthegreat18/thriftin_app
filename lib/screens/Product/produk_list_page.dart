            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: product['gambar'] != null
                          ? DecorationImage(
                              image: NetworkImage('http://10.0.2.2:8000/storage/${product['gambar']}'),
                              fit: BoxFit.cover,
                            )
                          : null,
                    ),
                  ...
                  Positioned(
                    ...
                    child: PopupMenuButton<String>(
                      onSelected: (value) {
                        if (value == 'edit') {
                          // Kirim product ke selectedProduct
                          context.read<ProductBloc>().add(ProductSelected(product));
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => const UploadProductPage()),
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(product['nama_produk'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Text("Rp ${product['harga']}", style: const TextStyle(color: Colors.grey)),
                  ],
                ),
              ),
              const Spacer(),
